...
<template>
  ...
  <div>
    This demo application and template demonstrates how to sign in Solana users
    into an IC canister using
    <a href="https://www.npmjs.com/package/ic-siws-js">ic-siws-js</a> and the
    <a href="https://github.com/kristoferlund/ic-siws">ic-siws-provider</a>
    canister.
  </div>
  ...
  <div class="container">
    ...
    <div v-if="siws.identity" id="icPrincipal">
      {{ siws.identity.getPrincipal().toString().slice(0, 6) }}...{{
        siws.identity.getPrincipal().toString().slice(-4)
      }}
    </div>
    ...
    <div
      v-if="
        siws.isPrepareLoginError || siws.isLoginError || !!siws.signMessageError
      "
      class="error"
      id="error"
    >
  ...
  <div class="links">
    <a
      href="https://github.com/kristoferlund/ic-siws-vue-demo"
      target="_blank"
      rel="noreferrer"
    >
      <img
        src="https://img.shields.io/badge/github-ic--siws--vue--demo-blue.svg?style=for-the-badge"
      />
    </a>
  </div>
</template>
